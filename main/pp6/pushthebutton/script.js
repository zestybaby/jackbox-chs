    ...
    HC = mn.extend({
        defaults: {
            ...
            strings: {
                ...
                vip_episodes_warning: "警告：用户创建内容并没有分级",
...
const Ii = rt.View.extend({
    ...
    showTwitchBroadcasterDialog(t) {
        ...
        e += `
            ...
            </div>`, this.lacksAudience ? e += "<div class='warning'>THIS GAME DOESN'T HAVE AN AUDIENCE FEATURE</div>" : this.client.roomInfo.audienceEnabled || (e += "<div class='warning'>THIS ROOM DOESN'T HAVE THE AUDIENCE SETTING ENABLED</div>"), xt.show("custom", {
            html: e,
            position: "bottom",
            timer: t,
            backdrop: "transparent",
